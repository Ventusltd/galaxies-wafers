 ...
 */
/* Marks are placed by whichever engine is chosen (engines.mjs); under the default
   that is the wafer's own frozen law, exactly as before. Layers stay keys. */
import { placeKey as place } from './engines.mjs';
/* Layers live at the repository root; this page sits two folders down. */
const ROOT = new URL('../../', import.meta.url);
const atRoot = p => new URL(p, ROOT).href;
