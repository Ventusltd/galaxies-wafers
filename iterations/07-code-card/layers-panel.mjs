...
const ROOT = '../../';   /* this iteration lives two folders below the wafer's root */
...
async function toggle(l, on) {
  ...
  /* iteration 07: tell the brightness overlay what is hydrated and showing */
  window.dispatchEvent(new CustomEvent('wafer:layer', { detail: { id: l.id, on, doc: s.status === 'OK' ? s.doc : null } }));
