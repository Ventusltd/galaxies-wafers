/* layers-panel.mjs — Code Card Everywhere (iteration 31): iteration 21's panel,
 * with its own tap-to-inspect listener removed. The tap now opens a code card
 * (card.mjs), which asks this file what lies under the finger through
 * window.__layers.pickAt. The drawing is unchanged.
 *
...
/* iteration 31: the tap belongs to the code card. What lies under a finger is
   answered here, from the precomputed positions, and nothing else. */
window.__layers = Object.freeze({ pickAt, inspect });
