...
async function tier1() {
  ...
  U.pos = placeAll(keys);
  /* Every line becomes clickable here, before anything is fetched: the grid is
     built from the positions just computed and never needs refreshing, because
     a key's place is a pure function of the key. See pick.mjs. */
